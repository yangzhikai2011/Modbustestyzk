...
public class SerialUtils {
    ...
    static {
        registerSerialPortFactory("com.fazecast.jSerialComm.SerialPort", "com.example.modbustest0309.jlibmodbus.serial.SerialPortFactoryJSerialComm");
        registerSerialPortFactory("jssc.SerialPort", "com.example.modbustest0309.jlibmodbus.serial.SerialPortFactoryJSSC");
        registerSerialPortFactory("purejavacomm.PureJavaComm", "com.example.modbustest0309.jlibmodbus.serial.SerialPortFactoryPJC");
        registerSerialPortFactory("gnu.io.RXTXVersion", "com.example.modbustest0309.jlibmodbus.serial.SerialPortFactoryRXTX");

        registerSerialPortFactory("com.google.android.things.AndroidThings", "com.example.modbustest0309.jlibmodbus.serial.SerialPortFactoryAT");
    }
